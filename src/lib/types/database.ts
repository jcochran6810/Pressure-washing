  ...
  public: {
    Tables: {
      ...
      google_drive_connections: {
        Row: { organization_id: string; refresh_token: string; access_token: string | null; access_token_expires_at: string | null; drive_folder_id: string | null; invoices_folder_id: string | null; estimates_folder_id: string | null; photos_folder_id: string | null; receipts_folder_id: string | null; scopes: string[] | null; connected_email: string | null; connected_at: string | null; updated_at: string | null };
        Insert: { organization_id: string; refresh_token: string; access_token?: string | null; access_token_expires_at?: string | null; drive_folder_id?: string | null; invoices_folder_id?: string | null; estimates_folder_id?: string | null; photos_folder_id?: string | null; receipts_folder_id?: string | null; scopes?: string[] | null; connected_email?: string | null; connected_at?: string | null; updated_at?: string | null };
        Update: { organization_id?: string; refresh_token?: string; access_token?: string | null; access_token_expires_at?: string | null; drive_folder_id?: string | null; invoices_folder_id?: string | null; estimates_folder_id?: string | null; photos_folder_id?: string | null; receipts_folder_id?: string | null; scopes?: string[] | null; connected_email?: string | null; connected_at?: string | null; updated_at?: string | null };
        Relationships: [];
      };
      invoice_line_items: {
